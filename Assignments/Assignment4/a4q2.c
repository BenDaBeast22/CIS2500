        ...
        while(!feof(fp)){
            ...
            if(line[0] != '\n'){
                ...
                numberSpaces = 11 - strlen(command);
                    ...
                    printf("count_up form 0 to %g\n", key);
                    printf("     ");
                    countup(0, key);
                }

                else if(strcmp(command, "count_down") == 0){
                    printf("count_down form %g to 0 by 2\n", key);
                    printf("     ");
                    countdown(key);
                }
                    ...
                    if(strcmp(order, "INSERTED_ORDER") == 0){
                        if(result != -1){
                            ...
                            printf("n = %d, FAILED, n>=size where size = %d\n",n, size(list));
                        }
                    }
                    else if(strcmp(order, "SORTED_ORDER") == 0){
                        if(result != -1){
                            printf("nth:");
                            for(i = 0; i < numberSpaces; i++){
                                printf(" ");
                            }
                            printf("n = %d, Key Sort Order\n",n);
                            printf("     %f  %d\n",key,value);
                        }
                        else{
                            printf("nth:");
